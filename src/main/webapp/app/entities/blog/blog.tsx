            ...
            <tbody>
              {blogList.map((blog, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{blog.title}</td>
                  <td>{blog.content}</td>
                  <td>{blog.publishDate ? <TextFormat type="date" value={blog.publishDate} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{blog.viewCount}</td>
                  <td>{blog.author ? <Link to={`/author/${blog.author.id}`}>{blog.author.name}</Link> : ''}</td>
