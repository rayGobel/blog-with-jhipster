...
class BlogResourceIT {
    ...
    void createBlog() throws Exception {
        ...
        assertThat(testBlog.getViewCount()).isEqualTo(DEFAULT_VIEW_COUNT);
    }
    ...
    void putExistingBlog() throws Exception {
        ...
        updatedBlog.title(UPDATED_TITLE).content(UPDATED_CONTENT).publishDate(UPDATED_PUBLISH_DATE).viewCount(UPDATED_VIEW_COUNT);
        ...
        assertThat(testBlog.getViewCount()).isEqualTo(UPDATED_VIEW_COUNT);
    }
    ...
    void partialUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.title(UPDATED_TITLE).viewCount(UPDATED_VIEW_COUNT);
    ...
    void fullUpdateBlogWithPatch() throws Exception {
        ...
        partialUpdatedBlog.title(UPDATED_TITLE).content(UPDATED_CONTENT).publishDate(UPDATED_PUBLISH_DATE).viewCount(UPDATED_VIEW_COUNT);
