...
class AuthorResourceIT {
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).location(DEFAULT_LOCATION);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).location(UPDATED_LOCATION);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getLocation()).isEqualTo(DEFAULT_LOCATION);
    }
    ...
    void putExistingAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).location(UPDATED_LOCATION);
        ...
        assertThat(testAuthor.getLocation()).isEqualTo(UPDATED_LOCATION);
    }
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.location(UPDATED_LOCATION);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).location(UPDATED_LOCATION);
